...
function mostrarInformacionDeCapa(layer) {
  if (layer.feature && layer.feature.properties.name) {
    ...
    sidebar.setContent(
      ` <div class="sidebar-container"><img class="sidebar-img" src="img/${layer.feature.properties.img_1}.jpeg"> <h2>Dirección:</h2> ${layer.feature.properties.name}<h2>Muralista:</h2>${layer.feature.properties.muralista}</div>`
    );
  }
}
